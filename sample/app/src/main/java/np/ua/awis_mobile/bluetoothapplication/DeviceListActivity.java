...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                setTitle(R.string.title_select_device_printer_to_connect);
                if (mNewDevicesArrayAdapter.getCount() == 0) {
                    String noDevices = getResources().getText(R.string.title_none_found).toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setFinishOnTouchOutside(false); // Prevent cancel outside
        mProgressBar = (ProgressBar) findViewById(R.id.pb_new_devices);
